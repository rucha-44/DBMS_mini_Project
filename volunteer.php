...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1 class="pagetitle-title text-center">Volunteer Form</h1>
      <!-- <nav>
        <ol class="breadcrumb">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form method="post">
                ...
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label">Project you want to be a part of</label>
                    <div class="col-sm-10">
                      <select class="form-select" aria-label="Default select example" name="project">
                        <option selected>Select</option>
                        <option value="1">Catalyse</option>
...
if(isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO volunteer (name, email, phoneNo, startDate, projectID) 
            VALUES ('$name', '$email', '$number', '$date', '$project')";

if ($conn->query($sql) === TRUE) {
  // Retrieve the auto-generated ID of the inserted record
  $volID = mysqli_insert_id($conn);
  
  // Prepare SQL statement to insert inventory details using the generated volID
  $inventorySql = "INSERT INTO inventory (inventory_name, quantity, useEvent, givento_Vol) 
                   VALUES ('$inventoryName', '$quantityUsed', '$eventID', '$volID')";

    // Execute SQL statement
    if ($conn->query($sql) === TRUE) {
        echo "Volunteer details saved successfully";
    } else {
